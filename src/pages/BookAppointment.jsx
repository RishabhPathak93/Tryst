          ...
          <div className="md:col-span-2">
            ...
            >
              ...
              <div className="mt-8 space-y-6">
                ...
                ].map(({ city, phone, address }) => (
                  <div key={city}>
                    <h3 className="text-lg font-medium text-salon-purple mb-2">{city}</h3>
                    <p className="flex items-center text-jet/70 mb-1">
                      <svg className="w-5 h-5 mr-2 text-salon-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      <a href={`tel:${phone.replace(/ /g, '')}`} className="hover:text-salon-purple transition-colors">
                        {phone}
                      </a>
                    </p>
                    <p className="flex items-start text-jet/70 whitespace-pre-line">
                      <svg className="w-5 h-5 mr-2 text-salon-purple mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
