...
// Removed the BlogPostType import since types are not used in JSX
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="title" className="block mb-2 text-sm font-medium text-jet">
                    Title
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="author" className="block mb-2 text-sm font-medium text-jet">
                    Author Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="category" className="block mb-2 text-sm font-medium text-jet">
                    Category
                  </label>
                  <select
                    id="category"
                ...
                <div>
                  <label htmlFor="image" className="block mb-2 text-sm font-medium text-jet">
                    Image URL (optional)
                  </label>
                  <input
                    type="url"
                ...
                <div>
                  <label htmlFor="content" className="block mb-2 text-sm font-medium text-jet">
                    Content
                  </label>
                  <textarea
                    id="content"
